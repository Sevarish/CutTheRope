...
function setup() {
    ...
    for (var i = 150; i < 400; i += 10) {
        if (rope1Static == true) {
            var boxRope1 = Bodies.rectangle(i, 10, 3, 3, { isStatic: true });
            rope1Static = false;
        }
        else {
            var boxRope1 = Bodies.rectangle(i, 100, 3, 3);
        }
        boxesRope1.push(boxRope1);
    }
    //Add all boxes of rope 1 to the Matter.js world.
    for (var i = 0; i < boxesRope1.length; i++) {
        World.add(world, boxesRope1[i]);
    }
    //Create boxes for rope 2.
    for (var i = 150; i < 400; i += 15) {
        if (rope2Static == true) {
            var boxRope2 = Bodies.rectangle(i, 110, 3, 3, { isStatic: true });
            rope2Static = false;
        }
        else {
            var boxRope2 = Bodies.rectangle(i, 300, 3, 3);
        }
        boxesRope2.push(boxRope2);
    }
    //Add all boxes of rope 2 to the Matter.js world.
    for (var i = 0; i < boxesRope2.length; i++) {
        World.add(world, boxesRope2[i]);
    }
    //Create boxes for rope 3.
    for (var i = 600; i < 900; i += 10) {
        if (rope3Static == true) {
            var boxRope3 = Bodies.rectangle(i, 210, 3, 3, { isStatic: true });
            rope3Static = false;
        }
        else {
            var boxRope3 = Bodies.rectangle(i, 300, 3, 3);
        }
        boxesRope3.push(boxRope3);
    }
    //Add all boxes of rope 3 to the Matter.js world.
    for (var i = 0; i < boxesRope3.length; i++) {
        World.add(world, boxesRope3[i]);
    }
    //Constraints for rope 1.
    for (var i = 1; i < boxesRope1.length + 1; i++) {
    ...
    for (var i = 1; i < boxesRope2.length + 1; i++) {
    ...
    for (var i = 1; i < boxesRope3.length + 1; i++) {
...
function draw() {
    ...
    var line1Draw = new PIXI.Graphics();
    if (rope1Active) {
        for (var i = 0; i < boxesRope1.length; i++) {
    ...
    var line2Draw = new PIXI.Graphics();
    if (rope2Active) {
        for (var i = 0; i < boxesRope2.length; i++) {
    ...
    var line3Draw = new PIXI.Graphics();
    if (rope3Active) {
        for (var i = 1; i < boxesRope3.length + 1; i++) {
...
function mouseSpeedCalc() {
    var dx = prevX - mousePosition.x;
    var dy = prevY - mousePosition.y;
...
function checkForCut() {
    ...
    for (var i = 0; i < boxesRope1.length; i++) {
        if (mousePosition.x > boxesRope1[i].position.x && mousePosition.x < boxesRope1[i].position.x + 10 && mousePosition.y > boxesRope1[i].position.y && mousePosition.y < boxesRope1[i].position.y + 10 && mouseDown == true && mouseSpeed > 0) {
            rope1Active = false;
            for (var j = 0; j < boxesRope1.length; j++) {
                World.remove(world, boxesRope1[j]);
            }
            for (var k = 0; k < rope1Constraint.length; k++) {
    ...
    for (var i = 0; i < boxesRope2.length; i++) {
        if (mousePosition.x > boxesRope2[i].position.x && mousePosition.x < boxesRope2[i].position.x + 10 && mousePosition.y > boxesRope2[i].position.y && mousePosition.y < boxesRope2[i].position.y + 10 && mouseDown == true && mouseSpeed > 0) {
            rope2Active = false;
            for (var j = 0; j < boxesRope2.length; j++) {
                World.remove(world, boxesRope2[j]);
            }
            for (var k = 0; k < rope2Constraint.length; k++) {
    ...
    for (var i = 0; i < boxesRope3.length; i++) {
        if (mousePosition.x > boxesRope3[i].position.x && mousePosition.x < boxesRope3[i].position.x + 10 && mousePosition.y > boxesRope3[i].position.y && mousePosition.y < boxesRope3[i].position.y + 10 && mouseDown == true && mouseSpeed > 0) {
            rope3Active = false;
            for (var j = 0; j < boxesRope3.length; j++) {
                World.remove(world, boxesRope3[j]);
            }
            for (var k = 0; k < rope3Constraint.length; k++) {
